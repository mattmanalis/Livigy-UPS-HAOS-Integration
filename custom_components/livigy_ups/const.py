...
SENSOR_DESCRIPTIONS = {
    ...
    "battery_capacity_percent": {"name": "Battery Capacity", "native_unit": "%"},
    "battery_remaining_minutes": {"name": "Battery Runtime", "native_unit": "min"},
    "battery_pack_voltage": {"name": "Battery Pack Voltage", "native_unit": "V", "device_class": "voltage"},
    "battery_piece_count": {"name": "Battery Piece Count"},
    "battery_group_count": {"name": "Battery Group Count"},
